...
void loop() {
  ...
  if (currentMillis - previousMillis >= 250)
  {
    ...
    target_angle = round((incomingData.potValue / 10.0) / 20.0) * 20.0; // Round to nearest 20 //target_angle = (incomingData.potValue / 10); // 157 is 180 deg
